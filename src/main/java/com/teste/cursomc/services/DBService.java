...
public class DBService {
	...
	public void instantiateDB( ) throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "linuxjf@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("1q2w3e"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "993838393"));
		
		Cliente cli2 = new Cliente(null, "Dona Antonia", "donana@gmail.com", "45903540040", TipoCliente.PESSOA_FISICA, pe.encode("1q2w3e"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27364444", "993348765"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Matos", "1120", "Sala 2", "Centro", "38777002", cli2, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("02/01/2019 13:05"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("03/01/2019 14:05"), cli1, e2);
		
		Pagamento pag1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pag1);
		
		Pagamento pag2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("15/01/2019 00:00"), null);
